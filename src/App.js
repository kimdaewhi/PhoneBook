...
function App() {
    ...
    const contactArr = [
        {id: 1, name: "Declan Rice", phoneNumber: "010-1234-5678", email: "declanrice@arsnal.co.uk"},
        {id: 2, name: "Gabriel Martinelli", phoneNumber: "010-9999-8888", email: "gabrielmartinelli@arsnal.co.uk"},
        {id: 3, name: "Martin Ødegaard", phoneNumber: "010-2222-3333", email: "odegaard98@arsnal.co.uk"},
    ]
    ...
    return (
        <div className="App">
            <ContactContext.Provider value={{ selectedContact, setSelectedContact }}>
                ...
                <br />
                <hr />
                <ContactDetailInfo selectedContact={selectedContact}/>
